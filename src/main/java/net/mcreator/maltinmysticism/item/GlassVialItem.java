...
public class GlassVialItem extends MaltinmysticismModElements.ModElement {
	@ObjectHolder("maltinmysticism:glass_vial")
	public static final Item block = null;
	public GlassVialItem(MaltinmysticismModElements instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to collect potions from cauldrons."));
		}
	}
}
