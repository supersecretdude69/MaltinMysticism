...
public class BlueChalkItem extends MaltinmysticismModElements.ModElement {
	@ObjectHolder("maltinmysticism:blue_chalk")
	public static final Item block = null;
	public BlueChalkItem(MaltinmysticismModElements instance) {
		super(instance, 39);
	}
