...
public class InsWaterTablet1Item extends MaltinmysticismModElements.ModElement {
	@ObjectHolder("maltinmysticism:ins_water_tablet_1")
	public static final Item block = null;
	@ObjectHolder("maltinmysticism:entitybulletins_water_tablet_1")
	public static final EntityType arrow = null;
	public InsWaterTablet1Item(MaltinmysticismModElements instance) {
		super(instance, 67);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletins_water_tablet_1").setRegistryName("entitybulletins_water_tablet_1"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ins_water_tablet_1");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Water Splash"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(InsWaterTablet1Item.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(InsWaterTablet1Item.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(InsWaterTablet1Item.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected ItemStack getArrowStack() {
			return new ItemStack(InsWaterTablet1Item.block, (int) (1));
		}
