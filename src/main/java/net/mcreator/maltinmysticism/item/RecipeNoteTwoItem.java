...
public class RecipeNoteTwoItem extends MaltinmysticismModElements.ModElement {

	@ObjectHolder("maltinmysticism:recipe_note_two")
	public static final Item block = null;

	public RecipeNoteTwoItem(MaltinmysticismModElements instance) {
		super(instance, 77);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof ShowRecipeTwoGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public ItemCustom() {
			...
			setRegistryName("recipe_note_two");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Movil Recipe");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ShowRecipeTwoGui.GuiContainerMod(id, inventory, packetBuffer);
					}
