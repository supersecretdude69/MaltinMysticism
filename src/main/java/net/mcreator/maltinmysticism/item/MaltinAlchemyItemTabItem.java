...
public class MaltinAlchemyItemTabItem extends MaltinmysticismModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("maltin_alchemy_item_tab");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The item representing the icon for the creative tab"));
		}
	}
}
