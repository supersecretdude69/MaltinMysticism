...
import net.mcreator.maltinmysticism.procedures.Use_MortarandpestleProcedure;
...
public class BlockDestillerBlock extends MaltinmysticismModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(0.7D, 0D, 0.7D, 0.3D, 0.5D, 0.3D).withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.create(0.3D, 0D, 0.3D, 0.7D, 0.5D, 0.7D).withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.create(0.3D, 0D, 0.7D, 0.7D, 0.5D, 0.3D).withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.create(0.7D, 0D, 0.3D, 0.3D, 0.5D, 0.7D).withOffset(offset.x, offset.y, offset.z);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				Use_MortarandpestleProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Destiller");
		}
