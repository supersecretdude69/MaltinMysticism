...
public class BlockCauldronEmptyBlock extends MaltinmysticismModElements.ModElement {
	@ObjectHolder("maltinmysticism:block_cauldron_empty")
	public static final Block block = null;
	@ObjectHolder("maltinmysticism:block_cauldron_empty")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BlockCauldronEmptyBlock(MaltinmysticismModElements instance) {
		super(instance, 1);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("block_cauldron_empty"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("block_cauldron_empty");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("block_cauldron_empty");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Empty Cauldron");
		}
