	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure CauldronRecipeArtificialMeat!");
			return;
		}
		...
		if (((new ItemStack(Blocks.AIR, (int) (1)).getItem() == (new Object() {
			...
			if (entity instanceof PlayerEntity) {
				...
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						ItemStack _setstack = new ItemStack(ArtificialMeatItem.block, (int) (1));
