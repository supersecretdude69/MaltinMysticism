...
package net.mcreator.maltinmysticism.particle;
...
public class ParticleBubblePurpleParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubblePurpleParticle(MaltinmysticismModElements instance) {
		super(instance, 18);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_purple"));
	}
