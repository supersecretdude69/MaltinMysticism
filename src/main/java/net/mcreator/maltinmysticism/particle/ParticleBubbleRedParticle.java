...
public class ParticleBubbleRedParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleRedParticle(MaltinmysticismModElements instance) {
		super(instance, 11);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_red"));
	}
