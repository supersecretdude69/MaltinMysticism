...
public class ParticleBubbleBlackParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleBlackParticle(MaltinmysticismModElements instance) {
		super(instance, 14);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_black"));
	}
