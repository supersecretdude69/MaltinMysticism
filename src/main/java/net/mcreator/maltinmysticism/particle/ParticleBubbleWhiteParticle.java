...
public class ParticleBubbleWhiteParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleWhiteParticle(MaltinmysticismModElements instance) {
		super(instance, 16);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_white"));
	}
