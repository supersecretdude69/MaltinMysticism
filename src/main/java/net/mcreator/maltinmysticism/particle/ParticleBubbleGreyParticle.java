...
public class ParticleBubbleGreyParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleGreyParticle(MaltinmysticismModElements instance) {
		super(instance, 13);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_grey"));
	}
