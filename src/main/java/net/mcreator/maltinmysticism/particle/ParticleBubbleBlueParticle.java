...
public class ParticleBubbleBlueParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleBlueParticle(MaltinmysticismModElements instance) {
		super(instance, 12);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_blue"));
	}
