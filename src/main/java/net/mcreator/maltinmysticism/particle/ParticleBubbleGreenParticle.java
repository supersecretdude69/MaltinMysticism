...
public class ParticleBubbleGreenParticle extends MaltinmysticismModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleBubbleGreenParticle(MaltinmysticismModElements instance) {
		super(instance, 15);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_bubble_green"));
	}
